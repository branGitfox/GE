...
-- Host: localhost
-- Database: ge
-- Generated at: 2026-03-01T18:17:16.595Z
...
(1, '     nouriture', 'sakafo', 'Sun Mar 01 2026 17:49:34 GMT+0100 (heure normale d’Europe centrale)');
...
(3, 1, NULL, NULL, NULL, NULL, 'Fact-001', 'Sun Mar 01 2026 00:00:00 GMT+0100 (heure normale d’Europe centrale)', '[{"produit_id":2,"nom":"vary","quantite":100,"prix":"4000.00","type_vente":"piece","unité":"kg","prix_carton":"200000.00","prix_piece":"4000.00","pieces_par_carton":250,"nom_unite_gros":"sac","unité_détail":"kg"}]', '400000.00', 3, 'Sun Mar 01 2026 19:16:49 GMT+0100 (heure normale d’Europe centrale)', NULL, NULL, '0.00', 'facture', '0.00');

-- Data for table `fournisseurs`
INSERT INTO `fournisseurs` (`id`, `nom`, `telephone`, `email`, `adresse`, `description`, `created_at`) VALUES
(1, 'koto', '032568452', '', 'uguig', '', 'Sun Mar 01 2026 17:51:42 GMT+0100 (heure normale d’Europe centrale)');
...
(1, 'biscuit ', 'Achat via Dépenses', '60.00', '10000.00', '0.00', 'carton', NULL, 1, 'Sun Mar 01 2026 17:52:27 GMT+0100 (heure normale d’Europe centrale)', 1),
(3, 'vary', 'Achat via Dépenses', '10.00', '150000.00', '0.00', 'sac', NULL, 2, 'Sun Mar 01 2026 18:09:52 GMT+0100 (heure normale d’Europe centrale)', 1);
...
(16, 'Test', 'User', 'admin@gmail.com', '$2b$10$yHqTxlF0vTm1lusc7sdv8OAyqEMTCNSkJcx5qmBw0oglnzfebAxhi', 'Admin', NULL, 'Mon Feb 23 2026 18:36:10 GMT+0100 (heure normale d’Europe centrale)', 0);
