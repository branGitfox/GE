...
-- Host: localhost
-- Database: ge
-- Generated at: 2026-03-01T18:53:34.830Z
...
(3, 1, NULL, NULL, NULL, NULL, 'Fact-001', '1899-11-29 23:50:39', '[{"produit_id":2,"nom":"vary","quantite":100,"prix":"4000.00","type_vente":"piece","unité":"kg","prix_carton":"200000.00","prix_piece":"4000.00","pieces_par_carton":250,"nom_unite_gros":"sac","unité_détail":"kg"}]', '400000.00', 3, NULL, NULL, NULL, '0.00', 'facture', '0.00');

-- Data for table `fournisseurs`
INSERT INTO `fournisseurs` (`id`, `nom`, `telephone`, `email`, `adresse`, `description`, `created_at`) VALUES
(1, 'koto', '032568452', '', 'uguig', '', NULL);
...
(4, 'biscuit', 'Achat via Dépenses', '10.00', '10000.00', '0.00', 'boite', NULL, NULL, '2026-03-01 17:53:05', 1);
...
(2, 'vary', '', 'sac', '2300.00', '200000.00', 'kg', 1, 250, '200000.00', '4000.00', '150000.00', 1);

-- Data for table `users`
INSERT INTO `users` (`id`, `nom`, `prenom`, `email`, `mdp`, `role`, `image`, `created_at`, `validated`) VALUES
(3, 'santatriniaina', 'feno nasandratra', 'santatriniainafeno01@gmail.com', '$2b$10$1.Ald1IUCK4ynyr75xIj/ul6QZEFUKa1sebmdot1QIvYN9bm9eeee', 'SuperAdmin', 'Prince.L ð¤´20250307_101604_Eden Garden by Prince ð».jpg', NULL, 1),
(6, 'First ', 'Admin', 's@gmail.com', '$2b$10$pYa12AG0ixLxnjSQUf.sVeoKvoTNySs/pbjKSbCwgvzlRAI/LvZcK', 'Admin', NULL, NULL, 1),
(15, 'santatriniaina', 'feno nasandratra', 'santatriniainafeno@gmail.com', '$2b$10$WIN3St4GTc0m/TBvTjgN/OuemKAHag0MZphdnjTXi6YEyFkFTkf1u', 'Admin', NULL, NULL, 1),
(16, 'Test', 'User', 'admin@gmail.com', '$2b$10$yHqTxlF0vTm1lusc7sdv8OAyqEMTCNSkJcx5qmBw0oglnzfebAxhi', 'Admin', NULL, NULL, 0);
