...
-- Host: localhost
-- Database: ge
-- Generated at: 2026-03-01T19:01:24.004Z
...
(1, '     nouriture', 'sakafo', '2026-03-01 17:54:05');
...
(4, 1, NULL, NULL, NULL, NULL, 'Fact-002', '2026-02-28 23:00:00', '[{"produit_id":3,"nom":"vary","quantite":20,"prix":"100000.00","type_vente":"carton","unité":"gony","prix_carton":"100000.00","prix_piece":"4000.00","pieces_par_carton":250,"nom_unite_gros":"gony","unité_détail":"kg"}]', '2000000.00', 3, '2026-03-01 17:59:10', NULL, NULL, '2000000.00', 'facture', '0.00');

-- Data for table `fournisseurs`
INSERT INTO `fournisseurs` (`id`, `nom`, `telephone`, `email`, `adresse`, `description`, `created_at`) VALUES
(1, 'koto', '032568452', '', 'uguig', '', '2026-03-01 17:54:05');
...
(4, 'biscuit', 'Achat via Dépenses', '10.00', '10000.00', '0.00', 'boite', NULL, 1, '2026-03-01 16:53:05', 1),
(5, 'vary', 'Stock Initial', '34.00', '80000.00', '100000.00', 'gony', 1, 3, '2026-03-01 17:58:02', 1);
...
(1, 'biscuit ', '', 'boite', '200.00', '15000.00', 'Pièce', 1, 10, '15000.00', '1500.00', '10000.00', 1),
(3, 'vary', '', 'gony', '3500.00', '100000.00', 'kg', 1, 250, '100000.00', '4000.00', '80000.00', 1);

-- Data for table `users`
INSERT INTO `users` (`id`, `nom`, `prenom`, `email`, `mdp`, `role`, `image`, `created_at`, `validated`) VALUES
(3, 'santatriniaina', 'feno nasandratra', 'santatriniainafeno01@gmail.com', '$2b$10$1.Ald1IUCK4ynyr75xIj/ul6QZEFUKa1sebmdot1QIvYN9bm9eeee', 'SuperAdmin', 'Prince.L ð¤´20250307_101604_Eden Garden by Prince ð».jpg', '2026-03-01 17:54:05', 1),
(6, 'First ', 'Admin', 's@gmail.com', '$2b$10$pYa12AG0ixLxnjSQUf.sVeoKvoTNySs/pbjKSbCwgvzlRAI/LvZcK', 'Admin', NULL, '2026-03-01 17:54:05', 1),
(15, 'santatriniaina', 'feno nasandratra', 'santatriniainafeno@gmail.com', '$2b$10$WIN3St4GTc0m/TBvTjgN/OuemKAHag0MZphdnjTXi6YEyFkFTkf1u', 'Admin', NULL, '2026-03-01 17:54:05', 1),
(16, 'Test', 'User', 'admin@gmail.com', '$2b$10$yHqTxlF0vTm1lusc7sdv8OAyqEMTCNSkJcx5qmBw0oglnzfebAxhi', 'Admin', NULL, '2026-03-01 17:54:05', 0);
